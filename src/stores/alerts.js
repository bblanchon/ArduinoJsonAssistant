...
export const useAlertsStore = defineStore("alerts", () => {
  ...
  const alerts = computed(() => {
    return [
      {
        if: cfg.isDeserializing && stats.nestingLevel > cpu.nestingLimit,
        id: "too-deep",
        type: "warning",
      ...
      {
        if: stats.longLongNeeded && !cpu.longLongIsDefault,
        id: "long-long",
        type: "warning",
      ...
      {
        if: stats.doubleNeeded && cpu.doubleSupported && !cpu.doubleIsDefault,
        id: "double",
        type: "warning",
      ...
      {
        if: stats.doubleNeeded && !cpu.doubleSupported,
